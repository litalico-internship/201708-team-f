...
# 予約
user = users.first
user.reservations.build(adviser_id: adviser1.id, start_time: Time.new(2017, 8, 19, 22), status: 0).save
user.reservations.build(adviser_id: adviser2.id, start_time: Time.new(2017, 8, 20, 23), status: 0).save
