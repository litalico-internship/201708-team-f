...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { adviser_id: @rate.adviser_id, comment: @rate.comment, rate: @rate.rate, user_id: @rate.user_id } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { adviser_id: @rate.adviser_id, comment: @rate.comment, rate: @rate.rate, user_id: @rate.user_id } }
